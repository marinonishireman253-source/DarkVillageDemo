...
Status: `External Brief`
Recommended use: `Send to Gemini or another image-generation model for UI asset production`
Not intended to replace: `UI architecture, gameplay specs, or project handoff docs`
